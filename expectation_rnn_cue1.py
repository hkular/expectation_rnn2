    ...
    def forward(self, stims, cues):
        ...
        for t in range( 0,stims.shape[0] ):
            ...
            if self.task_type == 'rdk_repro_cue':
                ...
                cue_input = 0
            next_x1 = ( ( 1-( self.dt/h_taus_sig1 ) ) * next_x1 ) + ( ( self.dt/h_taus_sig1 ) * ( stim_inp + self.h_layer1( r1 ) + fb_21 + cue_input ) )
            ...
            next_x3 = ( ( 1-( self.dt/h_taus_sig3 ) ) * next_x3 ) + ( ( self.dt/h_taus_sig3 ) * ( ff_23 + self.h_layer3( r3 ) ) )
