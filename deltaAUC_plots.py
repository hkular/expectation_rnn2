...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 14 15:52:09 2025
            ...
            for m in range(n_models):
                for l in range(n_layers):
                    ...
                    if classes == 'cue':
                        ...
                        # decay           
                        # x = t[stim_offset_win:]
                        # y = curve[stim_offset_win:]
                        # slope, _ = np.polyfit(x, y, 1)
                        # decay_rates[m, l, s] = slope
                        
                        # peak accuracy
                        # peak = np.max(curve[stim_offset_win:])
                        
                        # sustained accuracy
                        # sustained_acc[m, l, s] = np.mean(curve[stim_offset_win:sustain_win])
